...
export default function Catalog() {
    ...
    const [bids, setBids] = useState([]); // user bids
        ...
        <div className="min-h-screen flex flex-col bg-[#F2F8F2]">
            ...
            <main className="flex-grow px-4 md:px-10 py-10">
                ...
                <div className="flex justify-center md:justify-end mb-6">
                    <a
                        href="/catalog/new"
                        className="px-3 py-1 border border-green-700 font-semibold rounded-full shadow-lg text-green-800 hover:text-white hover:bg-green-800 transition text-base"
                    >
                        + Create Listing
                    </a>
                </div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <p className="text-gray-700 font-medium">
                                        {listing.type === "farmer" ? `JMD ${listing.price}` : `Offer: JMD ${listing.price}`}
                                    </p>
                                    <span
                                        className={`absolute top-2 right-2 px-2 py-1 rounded-full text-xs font-semibold ${listing.type === "farmer" ? "bg-green-700 text-white" : "bg-yellow-500 text-white"
                                            }`}
                                    >
                                        {badgeText}
                                    </span>
